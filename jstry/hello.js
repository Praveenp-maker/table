let cities=[
  ...
  //   }, {});
  // }
  // const byState = groupBy(cities, 'admin_name');
  // console.log(byState);

  // var del=cities.filter(e=>e.admin_name=="Tamil Nādu")
  // console.log(del.length)
  // console.log(del.map(e=>e.city))


  // var del=new Set(cities.map(e=>e.admin_name));
  // // console.log(del.length)
  // for(let i of del){
  //   var check=cities.filter(r=>r.admin_name===i);
 ...
 var largepop=cities.filter(e=>e.population_proper)
 var topValues = [...largepop].sort((a,b) => b-a).slice(0,9); 
// var topValues = largepop.sort((a,b) => b-a).slice(0,5);
 console.log(topValues);
 //console.log(largepop.map(e=>e.city))
